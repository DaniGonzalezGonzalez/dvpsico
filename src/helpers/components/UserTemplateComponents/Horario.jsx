  ...
  return (
    <>
        ...
        <div>{horario.map((item) => (
              ...
              <div className="flex items-center justify-center gap-3 m-8 md:w-1/3">
                <a href={item?.enlaceProyectoWeb} target="_blank" rel="noopener noreferrer">
                  <img className="object-cover w-48 h-48 rounded-lg cursor-pointer xl:w-72 xl:h-96" src={item?.url} alt="No hay imagen" />
                </a>
              </div>
